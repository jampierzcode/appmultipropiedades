...
const ListPropiedadesPageAsesor = ({
  settings,
  propiedades,
  asesorId,
  asesorNombre,
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
      {propiedades.map((prop, index) => {
        return (
          <Link
            to={`/asesor/${asesorNombre}/${asesorId}/proyectos/${prop.id}`}
            key={index}
          ...
          >
            ...
            <div className="px-4 py-4 bg-white">
              ...
              <div className="mt-4 w-full flex flex-wrap gap-3 items-center">
                ...
                <button
                  onClick={() => {
                    window.location.href = `/asesor/${asesorNombre}/${asesorId}/proyectos/${prop.id}`;
                  }}
...
export default ListPropiedadesPageAsesor;
